...
if (str (_display) != "no display") then
{
	...
	_ChildControl  ctrlSetTooltip format ["Ваш рівень: %2. Ціна наступного рівня: %1 ₴",1000 + (1.5*((skillFIA) *750)),skillFIA];
/*
	...
	if (isNil "_veh") then
		{
		_textX = "Немає техніки на продаж"
		}
	else
		{
