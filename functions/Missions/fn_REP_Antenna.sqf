...
[
	...
	"REP",
	[
		format ["Гівнюки відбудовують радіовежу в %1. Треба їм не дати цього зробити. Знищіть ремонтну вантажівку, чи захопіть зону до %2.",_nameDest,_displayTime],
		"Зупинити відбудовування радіовежі",
		_markerX
	],
	getPos _antennaDead,
