...
[[teamPlayer,civilian],"RES",[format ["Москалі збираються розстріляти групу наших в'язнів в %1. Треба їх врятувати до %2, і відвезти до штабу.",_nameDest,_displayTime],"Рятунок в'язнів",_markerX],_positionX,false,0,true,"run",true] call BIS_fnc_taskCreate;
...
if ({alive _x} count _POWs == 0) then
	{
	["RES",[format ["Москалі збираються розстріляти групу наших в'язнів в %1. Треба їх врятувати до %2, і відвезти до штабу.",_nameDest,_displayTime],"Рятунок в'язнів",_markerX],_positionX,"FAILED","run"] call A3A_fnc_taskUpdate;
	...
	{
	sleep 5;
	["RES",[format ["Москалі збираються розстріляти групу наших в'язнів в %1. Треба їх врятувати до %2, і відвезти до штабу.",_nameDest,_displayTime],"Рятунок в'язнів",_markerX],_positionX,"SUCCEEDED","run"] call A3A_fnc_taskUpdate;
