...
[_sideX,_markerX,[format ["Ворог атакує %1. Допоможіть захистити, якщо можливо.",_nameDest],format ["Є контакт з ворогом"],_markerX],getMarkerPos _markerX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
