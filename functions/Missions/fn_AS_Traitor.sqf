...
[[teamPlayer,civilian],"AS",[format ["Зрадник планує зустріч з %4 в %1. Ми точно не знаємо, де саме він буде, але ви його можете помітити біля позашляховика і %3. Застрельте того Павліка Морозова до %2, перш ніж він на нас настукає.",_nameDest,_displayTime,nameOccupants],"Вбити зрадника",_markerX],_posTsk,false,0,true,"Kill",true] call BIS_fnc_taskCreate;
[[Occupants],"AS1",[format ["Ми організували зустріч з інформатором %3 в %1, який може мати важливу для нас інформацію про їхній штаб. Захищайте його до %2.",_nameDest,_displayTime,nameTeamPlayer],"Захистити інформатора",_markerX],getPos _houseX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
...
if (not alive _traitor) then
	{
	["AS",[format ["Зрадник планує зустріч з %4 в %1. Ми точно не знаємо, де саме він буде, але ви його можете помітити біля позашляховика і %3. Застрельте того Павліка Морозова до %2, перш ніж він на нас настукає.",_nameDest,_displayTime,nameOccupants],"Вбити зрадника",_markerX],_traitor,"SUCCEEDED"] call A3A_fnc_taskUpdate;
	["AS1",[format ["Ми організували зустріч з інформатором %3 в %1, який може мати важливу для нас інформацію про їхній штаб. Захищайте його до %2.",_nameDest,_displayTime,nameTeamPlayer],"Захистити інформатора",_markerX],getPos _houseX,"FAILED"] call A3A_fnc_taskUpdate;
	if (_difficultX) then
		{
	...
	{
	["AS",[format ["Зрадник планує зустріч з %4 в %1. Ми точно не знаємо, де саме він буде, але ви його можете помітити біля позашляховика і %3. Застрельте того Павліка Морозова до %2, перш ніж він на нас настукає.",_nameDest,_displayTime,nameOccupants],"Вбити зрадника",_markerX],_traitor,"FAILED"] call A3A_fnc_taskUpdate;
	["AS1",[format ["Ми організували зустріч з інформатором %3 в %1, який може мати важливу для нас інформацію про їхній штаб. Захищайте його до %2.",_nameDest,_displayTime,nameTeamPlayer],"Захистити інформатора",_markerX],getPos _houseX,"SUCCEEDED"] call A3A_fnc_taskUpdate;
